...
public class SwerveDriveCommands {
   ...
   */
  public static Command feedforwardCharacterization(SwerveDriveSubsystem swerveDriveSubsystem) {
    ...
    return Commands.parallel(
        ...
        Commands.sequence(
            ...
            Commands.run(
                ...
                .finallyDo(
                    () -> {
                      double[] positions = swerveDriveSubsystem.getWheelRadiusCharacterizationPositions();
