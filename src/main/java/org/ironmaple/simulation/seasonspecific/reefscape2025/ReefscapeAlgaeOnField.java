 ...
 * <p>
 * The Algae (<a href=
 * "https://www.andymark.com/products/frc-2024?sku=am-5602">am-5602</a>) is a
 * 16-inch (41 cm)
 * rubber playground ball with a ±½ inch (~12 mm) diameter, featured as a game
 * piece in the 2025 Reefscape game.
 */
public class ReefscapeAlgaeOnField extends GamePieceOnFieldSimulation {
    public static final GamePieceInfo REEFSCAPE_ALGAE_INFO = new GamePieceInfo("Algae", new Circle(0.176),
            Inches.of(16), Kilograms.of(0.4), 1.8, 5, 0.8);
