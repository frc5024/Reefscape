 ...
 *
 * <p>
 * It extends {@link SimulatedArena} and includes specific details of the
 * Reefscape game environment.
 */
    ...
    public static final class ReefscapeFieldObstacleMap extends FieldMap {
        public ReefscapeFieldObstacleMap() {
            ...
            Translation2d[] reefVorticesRed = Arrays.stream(reefVorticesBlue)
                    .map(pointAtBlue -> new Translation2d(FieldMirroringUtils.FIELD_WIDTH - pointAtBlue.getX(),
                            pointAtBlue.getY()))
